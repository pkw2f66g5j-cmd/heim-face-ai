...
def _lux_potential_page(c, w, h, data, gender, page_num, total_pages):
    ...
    y -= 126
    _lux_card(c, 58, y, 225, 98, "Персональные рычаги", f"{_growth_focus_text(data)} · акцент: {_dominant_strength(data)['name']}.", accent=LUX_PURPLE, body_size=10.0, max_lines=3)
