...
main_keyboard = ReplyKeyboardMarkup(
    keyboard=[
        ...
        [KeyboardButton(text="👥 Получить разбор бесплатно")],
...
@dp.message(F.text == "👥 Получить разбор бесплатно")
async def referral_menu(message: Message):
    ...
    text = (
        ...
        "Ваша ссылка:\n"
        f"{link}\n\n"
        f"Приглашено: <b>{paid} / {goal}</b>\n\n"
        f"Пригласите {goal} друзей, которые оплатят любой тариф, "
        "и получите Premium Plan бесплатно."
    )
    if free > 0:
    ...
    try:
        ...
        try:
            ...
            await message.answer_photo(
                ...
                caption="Можете сохранить карточку или отправить друзьям.",
            )
        except Exception:
